...
from game.utils.constants import ENEMY_1, SCREEN_WIDTH, ENEMY_2,SCREEN_HEIGHT
...
class Enemy(Sprite):
    ...
    IMAG_ENEMY = {0:ENEMY_1,1:ENEMY_2}
    def __init__(self):
        self.image = self.IMAG_ENEMY[random.randint(0, 1)]
